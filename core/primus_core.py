...
class PrimusCore:
    ...
    def get_session_history(self, session_id: str, limit: int | None = None) -> List[Dict[str, Any]]:
        """
    ...
    def clear_session(self, session_id: str) -> bool:
        ...
        Return True if something was cleared, False if nothing was found.
        """
